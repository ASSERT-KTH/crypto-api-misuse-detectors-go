...
// 	out := generateServiceStr(repo, gitTag, goVer, svcName, analysisDir, []sast.Tool{})
// 	tests := []string{
// 		fmt.Sprintf("  %s:\n", svcName),
// 		"build:",
// 		"context: .",
...
// 	}
// 	if mc.ResultsDir != "outdir" {
// 		t.Errorf("ModComposer.Config.OutDir = %q; want %q", mc.ResultsDir, "outdir")
// 	}
// 	if mc.Parallelism != 2 {
...
// 	}
// 	if vc.ResultsDir != "dir2" {
// 		t.Errorf("VulComposer.Config.OutDir = %q; want %q", vc.ResultsDir, "dir2")
// 	}
// 	if vc.Parallelism != 3 {
