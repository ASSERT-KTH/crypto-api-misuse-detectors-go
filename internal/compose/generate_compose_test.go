...
// 	vulns, err := ParseVulnerabilities(tmpFile)
// 	if err != nil {
// 		t.Fatalf("readVulnerabilities() error = %v", err)
// 	}

// 	if vulns.Count() != 1 {
// 		t.Errorf("readVulnerabilities() got %d vulnerabilities, want 1", vulns.Count())
// 	}

// 	if vulns.GetVulnerabilities()[0].ID != 1 || vulns.GetVulnerabilities()[0].Repo.RepoSlug != "github.com/test/repo" {
